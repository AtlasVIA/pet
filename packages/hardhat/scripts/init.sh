...
yarn hardhat --network arbitrum-testnet deploy
yarn hardhat --network avalanche-testnet deploy
yarn hardhat --network base-testnet deploy
yarn hardhat --network celo-testnet deploy
yarn hardhat --network ethereum-testnet deploy
yarn hardhat --network optimism-testnet deploy
yarn hardhat --network polygon-testnet deploy
yarn hardhat --network mantle-testnet deploy
yarn hardhat --network meter-testnet deploy
yarn hardhat --network sonic-testnet deploy
yarn hardhat --network xlayer-testnet deploy
yarn hardhat --network zircuit-testnet deploy

yarn hardhat --network aleph-zero-testnet configure
yarn hardhat --network arbitrum-testnet configure
yarn hardhat --network avalanche-testnet configure
yarn hardhat --network base-testnet configure
yarn hardhat --network celo-testnet configure
yarn hardhat --network ethereum-testnet configure
yarn hardhat --network optimism-testnet configure
yarn hardhat --network polygon-testnet configure
yarn hardhat --network mantle-testnet configure
yarn hardhat --network meter-testnet configure
yarn hardhat --network sonic-testnet configure
yarn hardhat --network xlayer-testnet configure
