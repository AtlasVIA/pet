      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
        <div className="space-y-6 sm:space-y-8">
          <p className="text-gray-800 text-lg sm:text-xl leading-relaxed">
            Hey there, human friends! It&apos;s me, Blue! I&apos;m one lucky pup who found my forever home, and now I
            want to help other dogs feel the same tail-wagging happiness I do every day!
          </p>
          <p className="text-gray-800 text-lg sm:text-xl leading-relaxed">
            That&apos;s why I&apos;m the top dog (literally!) at Dogachi.Pet. It&apos;s a super fun game where you can
            play with virtual pets like me. But here&apos;s the really{" "}
            <span className="font-semibold text-indigo-600">pawsome</span> part - every time you play, you&apos;re
            helping real shelter dogs!
          </p>
          <p className="text-gray-800 text-lg sm:text-xl leading-relaxed">
            You see, when you take care of your Dogachi pet, it sends little donations to help real dogs in shelters.
            It&apos;s like giving them treats and belly rubs, but even better because it helps them find their own
            forever homes!
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 sm:p-8 shadow transition-all duration-500 ease-in-out hover:shadow-lg hover:scale-[1.02] hover:-translate-y-1">
            ...
            <ul className="list-none text-gray-800 text-lg sm:text-xl leading-relaxed mb-6 space-y-4">
              <li className="flex items-center">
                <span className="text-2xl mr-3">🍖</span> More yummy food and cozy beds for shelter pups
              </li>
              <li className="flex items-center">
                <span className="text-2xl mr-3">🎾</span> Lots of playtime and walks for dogs waiting for homes
              </li>
              <li className="flex items-center">
                <span className="text-2xl mr-3">📚</span> Help for humans to learn how to be the best pet parents
              </li>
              <li className="flex items-center">
                <span className="text-2xl mr-3">🏠</span> More dogs finding their perfect forever families
              </li>
            </ul>
